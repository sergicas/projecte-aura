...
function buildCloudflareInfrastructure(options = {}) {
  return {
    ...
    topology: [
      { id: "sergi", layer: "human", role: "usuari i operador amb Mode Sergi" },
    ...
    deployment: {
      ...
      postDeploy: ["/desa-backup", "/desa-integritat", "POST backup-worker /run amb Mode Sergi"],
    },
    reconstruction: [
      ...
      "Configurar AURA_WRITE_KEY com a secret de Pages i Worker sense exposar-ne el valor.",
...
function buildAuraWebInterface(options = {}) {
  const modules = [
    {
      id: "xat",
      label: "Xat",
      role: "conversa operativa i execució d'ordres",
      ...
      endpoints: ["/api/status", "/api/pulse", "/api/core", "/api/self-reflection", "/api/orientation"],
    },
    {
      id: "memoria",
      label: "Memòria",
      role: "records, memòria canònica, mapa, metamemòria i genoma digital",
      primaryElement: "memory-module",
      commands: [
        "/memoria",
        "/memoria-canonica",
        "/memoria-rica",
    ...
    },
    {
      id: "historia",
      label: "Història",
      role: "diari, línia evolutiva, vault i continuïtat",
      primaryElement: "history-module",
      commands: ["/diari", "/diari-evolutiu", "/continuïtat", "/backups"],
      endpoints: ["/api/diary", "/api/evolution", "/api/continuity", "/api/backups"],
    },
    {
      id: "estat",
      label: "Estat",
      role: "salut, integritat, infraestructura i restauració segura",
      primaryElement: "status-module",
      commands: [
        "/estat",
        "/capacitats",
        "/prova-gen 001",
    ...
    },
    {
      id: "cos",
      label: "Cos",
      role: "representació visual 2D derivada de senyals operatius",
      primaryElement: "body-module",
      commands: ["/cos-digital", "/estat-evolutiu", "/integritat", "/web"],
      endpoints: ["/api/body", "/api/evolution/state", "/api/integrity", "/api/web"],
    },
  ];
  ...
  return {
    ...
    layout: {
      shell: "identity-band + module-tabs + workspace",
    ...
    safeguards: [
      ...
      "La consola continua sent el camí canònic d'ordres.",
      "Els mòduls només reordenen la lectura, no dupliquen fonts de veritat.",
      "D1 continua sent la font de veritat i IndexedDB és fallback local.",
    ],
    verification: {
      command: "/web",
      endpoint: "/api/web",
      requiredPanels: ["xat", "memoria", "historia", "estat", "cos"],
